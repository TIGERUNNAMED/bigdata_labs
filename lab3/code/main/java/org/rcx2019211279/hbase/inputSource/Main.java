...
public class Main {
    ...
    public static final String NAME = "2019211279 Test1";
    public static final String TEMP_INDEX_PATH = "hdfs://rcx-2019211279-0001:8020/tmp/2019211279-rcx";
    public static String inputTable = "2019211279-rcx";
